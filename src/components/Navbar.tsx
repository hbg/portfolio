...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-white/30 border-b border-black/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link href="/" className="text-3xl lg:text-4xl text-black font-black italic">
              hbg
            </Link>
          </div>
          {/* Mobile Navigation Button - Hidden since we don't have navigation links */}
      ...
      {/* Mobile Navigation Menu - Hidden since we don't have navigation links */}
